...
import javafx.scene.{Scene, control, image}
...
class Main extends Application {
  ...
  private[this] val mediaViewHeight = 450
  ...
  override def start(primaryStage: Stage): Unit = {
    ...
    val scene = new Scene(baseBorderPane, mediaViewFitWidth + tableMinWidth, mediaViewHeight + toolBarMinHeight)
